...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ 
  ...
  const userSpecificServices = [
    ...
    },
    {
      ...
      icon: Building2,
      color: 'bg-purple-500',
      description: 'Choose insurance services'
    },
    {
      id: 'profile',
      label: 'Profile',
  ...
  return (
    <div className="min-h-screen bg-secondary/30">
      {/* Sidebar */}
      <div className="fixed inset-y-0 left-0 z-50 w-72 bg-[hsl(var(--sidebar-background))] border-r border-[hsl(var(--sidebar-border))]">
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-[hsl(var(--sidebar-border))]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-[hsl(var(--sidebar-foreground))]">Agent IGI Life</h2>
                <p className="text-sm text-[hsl(var(--sidebar-foreground))/0.7]">Insurance Portal</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-b border-[hsl(var(--sidebar-border))]">
            <Card className="bg-[hsl(var(--sidebar-accent))]">
              <CardContent className="p-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-[hsl(var(--sidebar-foreground))]">Portal Mode</span>
                  ...
                  <Select value={currentRole} onValueChange={handleRoleChange}>
                    <SelectTrigger className="w-full bg-[hsl(var(--sidebar-background))] border-[hsl(var(--sidebar-border))]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <nav className="p-4 space-y-2">
              <div className="text-xs font-semibold text-[hsl(var(--sidebar-foreground))/0.5] uppercase tracking-wider mb-3">
                Main Menu
              </div>
              {filteredNavigationItems.map((item) => (
                <Button
                  ...
                  variant="ghost"
                  className={cn(
                    "w-full justify-start gap-3 h-11 text-[hsl(var(--sidebar-foreground))] hover:bg-[hsl(var(--sidebar-accent))] hover:text-[hsl(var(--sidebar-accent-foreground))]",
                    activeTab === item.id && "bg-[hsl(var(--sidebar-primary))] text-[hsl(var(--sidebar-primary-foreground))] hover:bg-[hsl(var(--sidebar-primary))] hover:text-[hsl(var(--sidebar-primary-foreground))]"
                  )}
            ...
            {filteredServices.length > 0 && (
              <nav className="p-4 space-y-2">
                <div className="text-xs font-semibold text-[hsl(var(--sidebar-foreground))/0.5] uppercase tracking-wider mb-3 flex items-center gap-2">
                  ...
                  {filteredServices.map((service) => {
                    ...
                    return (
                      <Button
                        ...
                        variant="ghost"
                        className={cn(
                          "h-auto p-3 flex-col gap-2 text-[hsl(var(--sidebar-foreground))] hover:bg-[hsl(var(--sidebar-accent))] relative",
                          activeTab === service.id && "bg-[hsl(var(--sidebar-primary))] text-[hsl(var(--sidebar-primary-foreground))] hover:bg-[hsl(var(--sidebar-primary)]",
                      ...
                      >
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-xs text-[hsl(var(--sidebar-foreground))/0.5] mt-1">{service.description}</div>
                        </div>
                        {!hasAccess && (
          ...
          <div className="p-4 border-t border-[hsl(var(--sidebar-border))]">
            <div className="mb-3 p-3 bg-[hsl(var(--sidebar-accent))] rounded-lg">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[hsl(var(--sidebar-primary))] rounded-full flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[hsl(var(--sidebar-foreground))/0.7] truncate">{user?.email}</p>
            ...
            <Button
              variant="ghost"
              className="w-full justify-start gap-3 h-11 text-[hsl(var(--sidebar-foreground))] hover:bg-destructive hover:text-destructive-foreground"
              onClick={logout}
            >
