...
import { Plus, Edit, Trash2, Search, Filter, UserPlus, Shield, UserCheck, Crown } from 'lucide-react';
...
const UserManagement: React.FC = () => {
  ...
  const handleAddUser = () => {
    if (newUser.name && newUser.email) {
      ...
      setUsers([...users, user]);
      setNewUser({ name: '', email: '', role: 'user', agentId: '' });
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filter users by role, status, or search terms</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TableBody>
                {filteredUsers.map((user) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      {user.agentId ? (
                        <Badge variant="outline">{user.agentId}</Badge>
                      ) : (
